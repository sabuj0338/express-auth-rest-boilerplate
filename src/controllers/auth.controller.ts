...
export const register = catchAsync(async (req: Request, res: Response): Promise<void> => {
  ...
  successResponse(res, { user, tokens }, "User registered successfully", status.CREATED);
});
...
export const login = catchAsync(async (req: Request, res: Response) => {
  ...
  const tokens = await tokenService.generateAuthTokens(user);
  successResponse(res, { user, tokens }, "User logged in successfully", status.OK);
});
...
export const refreshTokens = catchAsync(async (req: Request, res: Response) => {
  ...
  successResponse(res, { ...userWithTokens }, "Tokens refreshed successfully", status.OK)
});
