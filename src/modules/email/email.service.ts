 ...
 * @returns {Promise<void>}
 */
export const sendResetPasswordEmailByOTP = async (to: string, otp: number): Promise<void> => {
  const subject = "Reset password";
  // replace this url with the link to the reset password page of your front-end app
  const text = `Hi,
 ...
 * @returns {Promise<void>}
 */
export const sendVerificationEmailByOTP = async (to: string, otp: number, name: string): Promise<void> => {
